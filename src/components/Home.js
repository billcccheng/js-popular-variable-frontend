  ...
  render(){
    return(
      <div id="home">
        ...
        <p>
        The last reason and the most important reason: Since I am not a native English speaker and believe me...naming variable is painful for non native speaker since we don't have the vocabulary size as a native speaker. During my undergraduate years in Taiwan, I had a lot of friends who were naming their variables in all sorts of strange name or to make matters worse: they had invented or misspelled a variable name they thought was something. Reading those code was a nightmare, not saying code reviewing them.
        </p>
        <p>
          To sum it up, I wish the app can be useful for people to reference how popoular prepos name their variables or functions. In the end, all good software developer learn from the best codes and I believe that the most popular repos are always a good place to start.
        </p>
        Bill Cheng
      </div>);
  }
